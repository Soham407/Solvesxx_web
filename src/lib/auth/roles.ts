...
export const ROLE_ACCESS: Record<AppRole, string[]> = {
  ...
  security_guard: ["/dashboard", "/test-guard", "/tickets", "/society", "/hrms/attendance", "/hrms/leave"],
  security_supervisor: ["/dashboard", "/test-guard", "/tickets", "/society", "/hrms/attendance", "/hrms/leave"],
  society_manager: ["/dashboard", "/society", "/test-resident", "/tickets", "/finance/compliance", "/service-requests", "/hrms/attendance"],
