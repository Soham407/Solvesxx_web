...
import { ShieldCheck, UserCheck, Search, Loader2, Home, Calendar } from "lucide-react";
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {results.map((resident) => (
          <Card key={resident.id} className="overflow-hidden border-none shadow-card hover:shadow-lg transition-all group">
              ...
              <div className="bg-primary/5 p-4 flex items-center gap-4 border-b border-primary/10">
                <div className="h-12 w-12 rounded-full overflow-hidden bg-background ring-2 ring-primary/20">
                  {resident.profile_photo_url ? (
                    <img src={resident.profile_photo_url} alt={resident.full_name} className="h-full w-full object-cover" />
                  ) : (
                ...
                <div>
                  ...
                  <Badge variant={resident.is_owner ? "default" : "secondary"} className="text-[10px] uppercase h-5 mt-1">
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {resident.move_in_date ? new Date(resident.move_in_date).toLocaleDateString() : 'N/A'}
                  </span>
                </div>
                
                <Button className="w-full mt-2 font-bold uppercase tracking-widest text-xs" variant="outline">
                  Log Entry
                </Button>
              </div>
            </CardContent>
