...
// Interactive Card variant for hover effects
...
// Premium Card variant with corner accent
const CardPremium = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div 
      ref={ref} 
      className={cn(
        "rounded-xl border bg-card text-card-foreground shadow-sm transition-all duration-300 overflow-hidden relative",
        "hover:shadow-lg hover:-translate-y-1 hover:border-primary/20",
        "corner-accent",
        className
      )} 
